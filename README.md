...
covering 141 functions, and merge, delete and partial read are written once.
...
answered from the relations actually held.
...
matters, because LPC requires the limit's `measurementId` to match MPC's.
...
byte. [More on the wire format](https://hupe1980.github.io/eebus/docs/wire-format/).
...
| | Restricted Function Exchange: partial read and write, delete, selectors | §5.3.4, SPINE IG §3.3 |
...
under [Conformance](https://hupe1980.github.io/eebus/docs/conformance/). What is
...
connections alive, resolves double connections, and redials with a backoff spread by the
