//! Configuration of Room Cooling System Function (CRCSF).
//!
//! A *Configuration Appliance* sets the operation mode of a room's cooling. It is the
//! writeable counterpart of [`mrcsf`](super::mrcsf), and the lever that lets a
...
//!
//! 1. **Set room cooling operation mode** — `auto`, `on`, `off` or `eco`, exactly one of
...
pub const NAME: &str = "configurationOfRoomCoolingSystemFunction";
...
const SCENARIO_NAME: &str = "Set room cooling operation mode";

/// The HVAC Room: the actor whose cooling is set.
