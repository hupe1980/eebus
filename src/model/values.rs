...
//!
//! The generated model mirrors the schemas exactly, which leaves one everyday job to
//! hand-written code: turning a [`ScaledNumber`] into a number you can compute with, and
//! back. The times SPINE carries as strings are the other job, and they are read by
//! [`parse_xs_date_time`](super::parse_xs_date_time) and
//! [`parse_iso8601_duration`](super::parse_iso8601_duration).

use crate::model::{Number, Scale, ScaledNumber};
